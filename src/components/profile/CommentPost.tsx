...
import ReplyCommentPost from "@/components/profile/ReplyCommentPost";
import {
    useGetReplyComments,
    useLikeCommentPost,
    useSendCommentPost,
...
export default function CommentPost({
    ...
    const sendComment = useSendCommentPost(postId);
    ...
    const likeComment = useLikeCommentPost(comment._id, postId);
